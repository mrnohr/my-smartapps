 ...
 */
definition(
		name: "Execute Phrase on Light Off",
		namespace: "mrnohr",
		author: "Matt Nohr",
		description: "Execute a phrase when a light turns off",
		category: "My Apps",
...
def initialize() {
	subscribe(switch1, "switch.off", lightHandler)
}
